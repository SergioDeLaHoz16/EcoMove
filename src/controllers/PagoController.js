...
export class PagoController {
  ...
  static procesar(pagoId) {
    try {
      ...
      const { PrestamoController } = await import('./PrestamoController.js');
  ...
  static obtenerEstadisticas() {
    ...
    return {
      ...
      promedioMonto: completados.length > 0 
        ? Math.round((montoTotal / completados.length) * 100) / 100 
        : 0
    };
  }
}