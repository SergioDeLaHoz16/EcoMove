...
import { EstacionForm } from "../../components/Administrador/EstacionForm.jsx"
...
function Estaciones() {
  ...
  if (mostrarFormulario) {
    return (
      <div>
        <EstacionForm onSubmit={handleCrearEstacion} onCancel={() => setMostrarFormulario(false)} />
      </div>
    )
  }
    ...
    <div className="space-y-6">
      ...
      {estaciones.length === 0 ? (
        <div className="bg-white rounded-lg shadow-md p-12 text-center">
          ...
          <button onClick={() => setMostrarFormulario(true)} className="text-blue-600 hover:text-blue-700 font-medium">
            ...
            return (
              <div key={estacion.id} className="bg-white rounded-lg shadow-md p-6 hover:shadow-lg transition-shadow">
                <div className="flex items-start justify-between mb-4">
                  ...
                  <div className="flex gap-1">
                    ...
                    <button
                      ...
                      title={
                        ocupacion.ocupados > 0
                          ? "No se puede eliminar: tiene transportes asignados"
                          : "Eliminar estación"
                      }
                    >
                ...
                <div className="space-y-3">
                  ...
                  <div className="text-xs text-gray-500 text-center">{ocupacion.porcentajeOcupacion}% ocupada</div>
                </div>

                <div
                  className={`mt-4 inline-flex px-2 py-1 rounded-full text-xs font-medium ${
                    estacion.activa ? "bg-green-100 text-green-800" : "bg-gray-100 text-gray-800"
                  }`}
                >
